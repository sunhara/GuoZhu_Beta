...
all_plateStructure = FilteredElementCollector(doc)
all_plateStructure.OfCategory(BuiltInCategory.OST_StructuralStiffener)
all_plateStructure.WhereElementIsNotElementType()
all_Ele = all_plateStructure.ToElements()
...
for group in ele_grouped:
    ...
    for i in item:
        ...
        target_para.Set("LJ-PL"+str(num))
    
    outputNummber.append("LJ-PL"+str(num))

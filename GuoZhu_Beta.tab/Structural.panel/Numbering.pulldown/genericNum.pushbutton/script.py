...
all_genericModel = FilteredElementCollector(doc)
all_genericModel.OfCategory(BuiltInCategory.OST_GenericModel)
all_genericModel.WhereElementIsNotElementType()
all_Ele = all_genericModel.ToElements()
...
for i in all_Ele:
    ...
    #collect all length
    length = i.get_Parameter(BuiltInParameter.INSTANCE_LENGTH_PARAM).AsDouble()
...
for group in ele_grouped:
    ...
    for i in item:
        ...
        target_para.Set("LJ-GM"+str(num))
    
    outputNummber.append("LJ-GM"+str(num))

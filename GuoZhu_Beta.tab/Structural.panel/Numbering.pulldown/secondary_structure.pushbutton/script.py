...
all_SecStructure = FilteredElementCollector(doc)
all_SecStructure.OfCategory(BuiltInCategory.OST_TemporaryStructure)
all_SecStructure.WhereElementIsNotElementType()
all_Ele = all_SecStructure.ToElements()
...
for group in ele_grouped:
    ...
    for i in item:
        ...
        target_para.Set("LJ-SS"+str(num))
    
    outputNummber.append("LJ-SS"+str(num))

...
all_tempStrure = FilteredElementCollector(doc)
all_tempStrure.OfCategory(BuiltInCategory.OST_TemporaryStructure)
all_tempStrure.WhereElementIsNotElementType()
